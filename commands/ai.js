...
module.exports = async (sock, chatId, message, args) => {
    try {
        ...
        await reply(sock, chatId, '🤖 Thinking...', message);
        const res = await axios.post('https://api-inference.huggingface.co/models/mistralai/Mistral-7B-Instruct-v0.2',
            { inputs:`<s>[INST] ${q} [/INST]`, parameters:{ max_new_tokens:250, temperature:0.7, return_full_text:false } },
        ...
        await reply(sock, chatId, `🤖 *ScottyMd AI*\n\n❓ ${q}\n\n💬 ${answer}\n\n_© ScottyMd by Scotty_`, message);
    } catch(e) { await reply(sock, chatId, '❌ AI unavailable. Try again later.', message); }
};
